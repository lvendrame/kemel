...
namespace Kemel.Orm
{
    public delegate bool EntityPredicate<TEntityPred, T>(TEntityPred ett, T value) where TEntityPred : EntityBase, new();
    ...
    public static class Extensions
    {
            ...
            where TEtt : EntityBase, new()
        {
            ...
            ett_Entity.EntityState = EntityItemState.Unchanged;
        ...
        #region public static bool IsNullable(this Type self)
        /// <summary>
        /// Determines whether the specified type is nullable.
        /// </summary>
        /// <param name="self">Type.</param>
        /// <returns>
